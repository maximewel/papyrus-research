...
labels = ["unaugmented", "augmented", "mixed", "unaugmented", "augmented", "mixed"]
...
colors_len_distrib = ["#4daf4a", '#1f77b4', '#d62728', '#9467bd', '#1f77b4', '#d62728', '#9467bd']
def plot_length_distribution(legends, distributions):
    fig = plt.figure()
    ...
    smalls_signals_distributions = distributions[0::3]
    large_signals_distributions =  distributions[1::3]
    all_signals_distributions =  distributions[2::3]

    leg = ["", "Early stop", "", "", "Natural stop", ""]

    smalls_signals_legends = legends[0::3] 
    smalls_signals_legends = ["Small Signals Ground Truth"] + leg
    large_signals_legends = legends[1::3]
    large_signals_legends = ["Large Signals Ground Truth"] + leg
    all_signals_legends = legends[2::3]
    ...
    names_color = [('Ground Truth', "#4daf4a"), ('Unaugmented', '#1f77b4'),  ('Augmented', '#d62728'),  ('Mixed', '#9467bd')]
...
def generate_signals_multithread():
    models_to_test = ["unaugmented", "augmented", "mixed"]
...
def create_figures_from_data():
    ...
    plot_distribution = plot_length_distribution(length_legends_distribution[0], length_legends_distribution[1])
